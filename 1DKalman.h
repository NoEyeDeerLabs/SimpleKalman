...
Usage is fairly straight forward. Create an instance of 1DKalman for each sample you
...
class 1DKalman {
  ...
  public:
    1DKalman(double process_noise_cv, double sensor_noise_cv, double estimated_error_cv, double start_val) {
      /* 
      */
